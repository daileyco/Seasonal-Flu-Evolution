...
## iqtree files
iqtree.list <- c(list.files("./01-Data/01-Processed-Data/alt/IQTREE/H3", full.names = T, pattern = ".iqtree"), 
                 list.files("./01-Data/01-Processed-Data/alt/IQTREE/H1", full.names = T, pattern = ".iqtree"), 
                 list.files("./01-Data/01-Processed-Data/alt/IQTREE/BVic", full.names = T, pattern = ".iqtree"), 
                 list.files("./01-Data/01-Processed-Data/alt/IQTREE/BYam", full.names = T, pattern = ".iqtree"))
...
log.list <- c(list.files("./01-Data/01-Processed-Data/alt/IQTREE/H3", full.names = T, pattern = ".log"),
              list.files("./01-Data/01-Processed-Data/alt/IQTREE/H1", full.names = T, pattern = ".log"),
              list.files("./01-Data/01-Processed-Data/alt/IQTREE/BVic", full.names = T, pattern = ".log"),
              list.files("./01-Data/01-Processed-Data/alt/IQTREE/BYam", full.names = T, pattern = ".log"))
...
lsd.list <- c(list.files("./01-Data/01-Processed-Data/alt/IQTREE/H3", full.names = T, pattern = ".lsd"),
              list.files("./01-Data/01-Processed-Data/alt/IQTREE/H1", full.names = T, pattern = ".lsd"),
              list.files("./01-Data/01-Processed-Data/alt/IQTREE/BVic", full.names = T, pattern = ".lsd"),
              list.files("./01-Data/01-Processed-Data/alt/IQTREE/BYam", full.names = T, pattern = ".lsd"))
...
## save
save(iqtree, file = "./01-Data/01-Processed-Data/alt/IQTREE_results.rds")
