...
alignments were read into r and trimmed to coding regions

```{r}
source("./02-Scripts/01-Data-Wrangling/process_Data_Alignments.R")
```
...
note only strata with at least 3 sequences have fasta files

```{r}
# source("./02-Scripts/01-Data-Wrangling/prep_Files_FASTA2.R")
source("./02-Scripts/01-Data-Wrangling/prep_Files_FASTA2alt.R")
# source("./02-Scripts/01-Data-Wrangling/prep_Files_FASTA2_seasontrees.R")
```


stratum-specific fasta files (sets of sequences) are piped to IQTREE2 software for maximum likelihood estimation of a phylogeny and subsequent phylogenetic dating; one stratum = two trees = one evolutionary tree + one time tree.


```{r}
# source("./02-Scripts/04-Analysis/reconstruct_Phylogenies_with_IQTREE.R")
source("./02-Scripts/04-Analysis/reconstruct_Phylogenies_with_IQTREEalt.R")
# source("./02-Scripts/04-Analysis/reconstruct_Phylogenies_with_IQTREE_seasontrees.R")
```
...
source("./02-Scripts/01-Data-Wrangling/process_Data_IQTREEalt.R")
# source("./02-Scripts/01-Data-Wrangling/process_Data_IQTREE_seasontrees.R")
```
...
source("./02-Scripts/01-Data-Wrangling/process_Data_Timetrees.R")
# source("./02-Scripts/01-Data-Wrangling/process_Data_Timetrees_seasontrees.R")
# source("./02-Scripts/01-Data-Wrangling/process_Data_Timetrees_seasontrees_monophy.R")
```
...
# source("./02-Scripts/01-Data-Wrangling/generate_Tree_Summaries_seasontrees.R")
```
...
```{r}
source("./02-Scripts/03-Visualization/generate_Figure_Coverage_Heatmap.R")
source("./02-Scripts/03-Visualization/generate_Figure_Coverage_Heatmap_Sequences.R")
source("./02-Scripts/03-Visualization/generate_Figure_Coverage_Heatmap_TreeStats.R")
```
...
```{r}
source("./02-Scripts/03-Visualization/generate_Figure_Cors_Heatmap.R")
```
